...
export const mockFilm = {
  backgroundColor: '#A6B7AC',
  backgroundImage:
    'https://8.react.pages.academy/static/film/background/gangs_of_new_york.jpg',
  description:
  ...
  name: 'Gangs of new york',
  posterImage:
    'https://8.react.pages.academy/static/film/poster/Gangs_of_New_York_Poster.jpg',
  previewImage:
    'https://8.react.pages.academy/static/film/preview/gangs_of_new_york.jpg',
  previewVideoLink:
